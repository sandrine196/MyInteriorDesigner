...
function GoInner() {
  ...
  return <div className="w-6 h-6 rounded-full border-2 border-stone-300 border-t-stone-700 animate-spin" />;
}

export default function GoPage() {
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: "#F7F6F3" }}>
      <Suspense fallback={<div className="w-6 h-6 rounded-full border-2 border-stone-300 border-t-stone-700 animate-spin" />}>
        <GoInner />
      </Suspense>
    </div>
  );
